  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      setResults({
        ...
        fileName: file.name,
        duplicates: [],
        error: 'Failed to parse XML file. Please check the file format.'
      });
    } finally {
      setLoading(false);
    }
      ...
      <div className="relative z-10 container mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
           Analyzer XML files to find duplicate ObjectId values in Visualisation objects.
          </p>
        </div>
                      ...
                      <div className="text-center">
                        ...
                        <div className="space-y-2">
                          {file ? (
                            ...
                            <>
                              <p className="text-lg font-medium text-gray-700">Drag file here or click to select</p>
                              <p className="text-sm text-gray-500">Supports XML files only</p>
                            </>
                          )}
                        </div>
                      </div>
                    ...
                    {results.success && results.duplicates.length > 0 && (
                      <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
                        <CardContent className="pt-6">
                          ...
                          <p className="text-sm text-gray-600">{Math.round(progressPercentage)}% completed</p>
                        </CardContent>
                      </Card>
                    )}
                          ...
                          <>
                            ...
                            {results.duplicates.length > 0 ? (
                              <div className="space-y-8">
                                ...
                                <section>
                                  <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h3 className="text-lg font-bold text-gray-800">Pending Items</h3>
                                ...
                                {completedItems_list.length > 0 && (
                                  <section>
                                    <div className="flex items-center gap-3 mb-4">
                                      ...
                                      <h3 className="text-lg font-bold text-gray-800">Completed Items</h3>
                              ...
                              <div className="p-8 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl text-center">
                                ...
                                <p className="text-gray-600 text-lg font-medium">No duplicate ObjectIds found according to the specified criteria</p>
                              </div>
                            )}
                          </>
                        ) : (
                  ...
                  <CardContent>
                    <div className="grid gap-4">
                      <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-lg">
                        ...
                        <p className="text-gray-700">Shows results for duplicate ObjectIds (appear more than once) for regular classes</p>
                      </div>
                      <div className="flex items-start gap-3 p-4 bg-green-50 rounded-lg">
                        ...
                        <p className="text-gray-700">For &quot;DistanceSensor&quot; or &quot;ConveyorGroup&quot; classes, shows results only if they appear more than 3 times</p>
                      </div>
                      <div className="flex items-start gap-3 p-4 bg-purple-50 rounded-lg">
                        ...
                        <p className="text-gray-700">Searches for ViewObject elements and extracts ObjectId property values</p>
                      </div>
                      <div className="flex items-start gap-3 p-4 bg-amber-50 rounded-lg">
                        ...
                        <p className="text-gray-700">Supports XML files only with drag &amp; drop functionality</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
